...
run-examples-rust: ## Run all Rust examples
	...
	@for example in basic_usage browser_driver_usage sogou_weixin_search simple_usage search_engine_default search_engine_brave search_engine_serper search_cascade; do \
...
run-examples-python: install-dev ## Run all Python examples
	...
	@for example in basic_usage.py sogou_weixin_search.py search_cascade.py search_engine_serper.py; do \
